...
const ERA_CONFIG = {
  ...
  "Recent Acquisitions": {
    image: "https://feazglrunmdmgugdhhnh.supabase.co/storage/v1/object/public/the-collection-images/Recent2.jpg",
  ...
  "World War II": {
    image: "https://feazglrunmdmgugdhhnh.supabase.co/storage/v1/object/public/the-collection-images/WW2%202.jpg",
    label: "World War II",
    years: "1939 – 1945",
    description: "",
    accent: "#3a4a5c",
  ...
  "Vietnam War": {
    image: "https://feazglrunmdmgugdhhnh.supabase.co/storage/v1/object/public/the-collection-images/Nam.jpg",
    label: "Vietnam War",
    years: "1955 – 1975",
    description: "",
    accent: "#5c4a3a",
...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── ERA SELECTION ── */
  .era-page { min-height: 100vh; background: #f7f4ef; padding-top: 80px; }
